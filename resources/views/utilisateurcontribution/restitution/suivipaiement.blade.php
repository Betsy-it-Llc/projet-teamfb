...
@section('content')
    ...
    <p class="text-lg font-sans text-gray-400 text-center relative sm:right-10 md:left-7 lg:left-10">All Project</p>
        ...
        <table class="table">
          ...
          <thead>
            <tr>
              ...
              <th class="text-nom-colonne-tableau">Type</th>
              <th class="text-nom-colonne-tableau">Nom</th>
            </tr>
          </thead>
          <tbody>
            ...
            <tr class="">
              ...
              <td>{{ $contribution->cagnotte->projet->types_projet->valeur }}</td>
