...
<div style="display: flex; flex-direction: column; width: 100%;">
    ...
    <div style="display: flex; justify-content: center; background: #ffff; width: 100%; height: 100px; align-items: end;">
        <h1 style="font-weight: bolder">Soutenir une organisation</h1>
    </div>
    <div style="display: flex; justify-content: center; width: 100%;">
        <a href="{{route('utilisateur.soutenirprojet')}}" class="menu-link " style="text-decoration: none; color: black; margin-right: 200px; font-weight: bold;">Projet</a>
        <a href="{{route('utilisateur.soutenircause')}}" class="menu-link" style="text-decoration: none; color: black; margin-right: 200px; font-weight: bold;">Cause</a>
        <a href="{{route('utilisateur.soutenirexperience')}}" class="menu-link" style="text-decoration: none; color: black; margin-right: 200px; font-weight: bold;">Expérience</a>
        <a href="{{route('utilisateur.soutenirorganisation')}}" class="menu-link selected" style="text-decoration: none; color: black; font-weight: bold;">Organisation</a>
      </div>
