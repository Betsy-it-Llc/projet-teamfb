...
@section('content')
        ...
        <div class="grid grid-cols-1 grid-rows-2 gap-0.5 pl-5 relative">
            ...
            <p class="text-xl telM:text-3xl font-sans font-bold text-black text-left relative 2xl:left-36">Experience</p>
        </div>
        ...
        <form action="{{ route('utilisateur.searchexperience') }}" method="GET">
            @csrf
