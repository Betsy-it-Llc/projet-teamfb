...
@section('content')
<title>Create Produit Service</title>
<div class="container">
    <form action="{{ route('produitservice.store') }}" method="post">
        @csrf
        @if($errors->any())
        ...
        <div class="col-xl-3 col-lg-3 col-md-12 col-sm-12 col-12" style="margin-left:50px">
            <div class="card h-100" style="width:450px;margin-left:50px">
                <div class="card-body" style="height:400px;">
                    <center> <h1 style="margin-bottom:40px"> Création de Produit Service</h1>
        ...
        <div class="col-xl-3 col-lg-3 col-md-12 col-sm-12 col-12" >
            <div class="card h-100" style="width:420px;margin-left:300px">
                <div class="card-body"style="margin-right:0px">
                    ...
                    <div class="form-contact" style="margin-top:20px">
                            <input type="text" name="nom_produit" class="form-control" value="{{old('nom_produit')}}"  placeholder="Nom*">
                    </div>
                    <div class="form-contact" style="margin-top:20px;margin-bottom:20px">
                            <input type="text" name="prix" class="form-control" value="{{old('prix')}}"  placeholder="Prix*" style="width:340px;float:left;margin-bottom:20px;margin-right:10px">
                            <a href=""><b style="font-size:2em;color:green">€</b></a>  
                    </div>        
                    <div class="form-contact" style="margin-top:20px">
                            <input type="text" name="abstract" class="form-control" value="{{old('abstract')}}"  placeholder="Abstract*">
                    </div>
                    <div class="form-contact" style="margin-top:20px">
                        <h6 style="color:black;margin-left:10px">Categorie Produit<span style="color:red;">*</span></h6>
                    </div>
                    <div class="form-contact" style="margin-bottom:20px">
                    <select name="categorie" id="pet-select" style="background-color:white;margin-bottom:20px;width:340px;height:35px;float:left;border-radius:4px;border-color:black">
                    ...
                    <div class="form-contact" style="margin-top:20px">
                        <!-- <label style="color:black;margin-left:10px;  font-size: 1rem; font-family: inherit;  font-weight: 500;  " for="description">Description<span style="color:red;">*</span></label> -->
                        <h6 style="color:black;margin-left:10px; display: inline-block;">Description<span style="color:red;">*</span></h6>
                    </div>
                    <div class="form-contact" style="">
                        <!-- <input type="text" name="description" class="form-control" value="{{old('description')}}" style="height:120px" placeholder="Description"> -->
                        <textarea id="description" name="description" class="form-control" placeholder="Description" style="height:120px" cols="30" rows="5">{{old('description')}} </textarea>
                    </div>
                    <div class="form-contact" style="margin-top:20px;">
