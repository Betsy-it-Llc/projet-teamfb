...
<div class="container"  style="width:100%;margin:0">
    ...
    <div id="content" class="content p-0" >
        ...
        <center>
            <b style="margin-bottom :20px;font-size:2.5rem;">Info Partenaire</b>
        </center>    
        ...
        <table>
                <tr>
                    ...
                    <div class="profile-header-img" style="background:none;height:110%">
                                    ...
                                    href="{{ route('partenaires.edit', $con->id_partenaire) }}"><i style="color : green;"
                    ...
                    <div class="profile-header-name" >
                           <table>
                            ...
                            <td style="text-align:center">{{ $con->type }}</td>
                            </tr>
                            <tr>
                                
                                
                                <td style="text-align:right;width:40%"><b >Profil : </b></td>
                                <td style="text-align:center">{{ $con->fonction }}</td>
                            </tr>
                           </table>
        ...
        <div class="profile-container">
            ...
            <div class="col-md-4 hidden-xs hidden-sm" style="max-width:20%">
                    <div class="tab-content p-0">
                        <div class="tab-pane active show" id="profile-about">
                            ...
                            <thead>
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="{{ route('partenaires.updatedesc') }}" method="POST">
                                                        @csrf
                                                
                                                        <input type="hidden" id="id_contact" name="id_contact" value="{{ $con->id_contact }}"> 
                                                        <input type="hidden" id="id_partenaire" name="id_partenaire" value="{{ $url }}"> 
                                ...
                                <tbody>
                                    ...
                                    <td style="text-align: justify;padding:0.5rem">
                                        ...
                                        <pre style="white-space: pre-line; text-align:left; margin:0; width: 100%; ">{{ $description }}</pre>
                            ...
                            <div class="h-100 d-flex align-items-center justify-content-center" style="width:fit-content">
                                <!-- --------------------------yasser------------------------------------------------- -->
                                <!-- ----------------------------  Intéractions  ----------------------------------- -->
                                    <table class="table table-profile" style="margin-top:150px;">
                                        <thead>
                                            <tr>
                                                ...
                                                @foreach ($interactions as $int)
                                                    <li class="tl-item" ng-repeat="item in retailer_history" style="padding:0 0 2rem 2rem">
                                                        <div class="timestamp" style="padding:0 0 0 0;font-size:0.75em;color:#333333; width:100px; text-align:left;">                                                            
                                                            ...
                                                            <button formaction="/partenaires.destroyinteraction/{{ $int->id_interaction }}/{{ $con->id_partenaire }}"
                                                                style="background:none ; border : none;" type="submit" class="btn btn-danger"
                                                                onclick="return confirm('Are you sure you want to delete ?')"><i
                ...
                <div class="col-md-4 hidden-xs hidden-sm" style="max-width:20%;">
                    <div class="tab-content p-0" >
                        ...
                        <table class="table table-profile" style="margin-bottom:1px;margin-left:30px;">
                            ...
                            <table style="width: 210%;margin-left:30px">
                                <thead>
                                <tr>
                                        <th colspan="2" style="padding:1rem 0 1rem 9rem;color:black"><b style="font-size:2.2em;">Remise</th>
                                        </tr>
                                </thead>
                            </table>
                            
                            <table style="width: 220%;margin-left:30px">
                                <tbody >
                                <tr>
                                ...
                                <tr >
                                    <td>{{ $code->nom_remise }}</td>
                                    <td>{{ $code->code }}</td>
                                    <td>{{ $code->taux }}%</td>
                                    <td>{{ $code->nb_utilisation }}</td>
                                    <td style="padding:0 0 0 1.5rem">{{ $code->nb_utilisation - $code->numRemises }}</td>
                                    <td style="padding:0 0 0 1.5rem">{{ $code->montant }}€</td>
                                    </tr>
                                @endforeach
                        ...
                        <!-- ------------------------------------  Intéraction Storytelling  ---------------- -->
                            <table style="width: 400%; margin-top:100px">
                                   <thead>
                                        <tr>
                                            <th colspan="2" style="padding:3rem 0 1rem 10rem;color:black"><b style="font-size:2.2em;">Intéraction Storytelling 
                                            ...
                                            <tr>
                                                ...
                                                <tr style="float:left ;border-radius:10px;">
                                                    <td style=" text-align: justify;padding:0.5rem"> 
                                                        @foreach($les_tags_lier_avec_story as $tags)
                                                            ...
                                                            @endif
                                                        @endforeach
                                                        <pre style="width:100%; margin:0; white-space: pre-line;"> 
                                                            {{ $story->description }} 
                                                        </pre>
                                                    </td>  
                                                </tr>
                                                <tr>
                                                    <td style="text-align:center">
                                                        ...
                                                        <!-- ------------------------------------- -->
                                                        <button formaction="/partenaires.destroystorytelling/{{ $story->id_storytelling }}/{{ $con->id_partenaire }}"
                ...
                <div class="col-md-4 " style="max-width:20%">
                    <div class="tab-content p-0">
                        <div class="tab-pane active show" id="profile-about" style="margin-left:35px;max-width:120%">
                        
                                    <table class="table table-profile">
                                    <thead>
                                    <tr style="padding:0;">
                                        <th style="padding:0 0 0;" colspan="2">Info Remise   </th>
                                    </tr>
                                        
                                    </thead>
                                    
                                        </table>
                                        <table class="table table-profile" style="margin-left:0">
                                        <tbody  >
                                    <tr>
                                        <td class="field" style="width:100%;">Type: </td>
                                        <td class="value" >
                                            facture
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="field">Taux: </td>
                                        <td class="value">
                                            30%
                                        </td>
                                    </tr>
                    ...
                    <div class=" " style="max-width:15%">
                    <div class="tab-content p-0">
                        <div class="tab-pane active show" id="profile-about" style="margin-left:50px;width:160%">
                            @if (!is_null($entreprise))
                            ...
                            @endif
                                ...
                                <thead>
                                    <tr style="padding:0;">
                                        <th style="padding:0 0 0 0;"  colspan="2">Liste Expérience   </th>
                                    </tr>
...
<div class="formclt">
    <div class="form-int" id="intForm">
        <form action="{{ route('partenaires.createinteraction') }}" method="post" class="form-container">
            @csrf
            <h4 style="text-align:start;margin-top:30px">Ajouter une nouvelle interaction liée au partenaire {{ $con->id_contact }}</h4>
            <input type="hidden" id="id_contact" name="id_contact" value="{{ $con->id_contact }}"> 
            <input type="hidden" id="id_partenaire" name="id_partenaire" value="{{ $url }}"> 
    ...
    <div class="form-story" id="storyForm">
        <form action="{{ route('partenaires.createstorytelling') }}" method="post" class="form-container">
            @csrf
            <input type="hidden" id="id_contact" name="id_contact" value="{{ $con->id_contact }}"> 
            <input type="hidden" id="id_partenaire" name="id_partenaire" value="{{ $url }}"> 
