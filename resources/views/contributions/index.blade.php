...
@section('content')
    ...
    <title>Liste Contributions</title>
    <div class="row">
...
@endif
        <div class="col-lg-12" style="margin-bottom : 30px">
            ...
            <center> <tr>
                ...
                <th><b style="font-size:3rem;color:#333333">Contributions</b></th>
            ...
            <section class="search-sec" style="margin : 20px ; font-size : 13px">
                <div class="container" style="margin-left : 0">
                    ...
                    <form action="{{ url ('/contributions.index') }}" method="get" novalidate="novalidate">
                        <div class="row">
                            <div class="col-lg-40">
                                <div class="row">
                                    ...
                                    <div class="col-lg-2 col-md-2 col-sm-30 p-0">
                                        <input class="form-control" type="text" name="multisearchexperience" id="experience"
            ...
            <div>
                <p> Il y'a : {{ $totalContributions }} Contributions
                </p>
            </div>
        </div>
    </div>
                ...
                <thead class="thead" style="background:#cccccc">
                    ...
                    <tr>
                        ...
                        <th scope="row"><input type="checkbox" name="ids[]" class="selectbox"
                                    value="{{$contribution->id_contributions}}"></th>
                            <td> <a href="#"target="_blank">{{$contribution->id_contributions}}</a></td>
                            <td>{{ $contribution->contact->prenom }}</td>
                            <td>{{ $contribution->contact->nom }}</td>
                            ...
                            <td>
                                <a style="background-color: #fff; border: #fff" class="btn btn-info"
                                    href="{{ route('contributions.show', ['id_contributions' => $contribution->id_contributions]) }}">
