...
@endif
        <div class="col-lg-12" style="margin-bottom : 30px">
            ...
            <center> <tr>
                ...
                <th><b style="font-size:3rem;color:#333333">Clients</b></th>
                <th><b style="font-size:1.5rem;color:#333333">Total : {{ $totalCount }}</b></th>
              </tr><br><br>
                <center>
                    ...
                    <tr>
                        ...
                        <th><pre>   </pre></th>
                        <th id="dash" style="border:4px solid black;  float:right ;border-radius:30px;  width: 200px ">
            ...
            <section class="search-sec" style="margin : 20px ; font-size : 13px">
                <div class="container" style="margin-left : 0">
                    ...
                    <form action="{{ url ('/clients.index') }}" method="get" novalidate="novalidate">
                        <div class="row">
                            <div class="col-lg-40">
                                <div class="row">
                    ...
                    <tr>
                        <th scope="row"><input type="checkbox" name="ids[]" class="selectbox"
                            ...
                            <td>
                                ...
                                href="{{ $value->url_client_stripe }}"><img src="{{ asset('img/stripe.png') }}" style="width:1em;height:1em;" ></a>
                                @endif
                            </td>
                            ...
                            <td>
                                <a style="background-color : #fff ; border : #fff" class="btn btn-info"
                                    href="{{ route('clients.show', ['id_contact'=>$value->id_contact]) }}"><i style="color : #4d94ff"
                                        class="fas fa-info"></i></a>
                                    <a style="background-color : #fff ; border : #fff" class="btn btn-primary"
                                    href="{{ route('clients.edit',['id_contact'=> $value->id_contact]) }}"><i style="color : #e6ac00"
                                        class="fas fa-edit"></i></a>
                                <button formaction="{{ route('clients.destroy', ['id_contact'=>$value->id_contact,'id_experience'=>$value->id_experience]) }}"
