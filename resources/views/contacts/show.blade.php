...
<head>
    <title>{{ $con->prenom }} {{ $con->nom }} </title>
...
<div class="container" style="width:100%;margin:0">
    ...
    <div id="content" class="content p-0">
        <div class="profile-header">
            <center>
                <b style="margin-bottom :20px;font-size:2.5rem;">Info Contact</b>
            </center>
        ...
        <div class="profil-container">
            <table>
                <tr>
                        ...
                        <td>
                            <div class="profile-header-content">
                                <div class="profile-header-img" style="background:none;height:110%">
                                    ...
                                    <button formaction="/contacts.destroy/{{ $con->id_contact }}"
                    ...
                    <button style="background: none ; border : none;margin-left:10px" class="btn btn-primary"
                        onclick="openFormCode()">
                        <i class="fas fa-solid fa-receipt" style="color: #476fab;"></i>
                    </button>
        </div>
        <!-- pop-up parrainage-->
        <div class="code-popup ">
            <form action="{{ route('clients.createcodeparrain', ['contact' => $con->id_contact]) }}" method="post">
                <div class="form-code" id="popupForm" style="background-color: #c8c7cc">
                    <h2 style="text-align:left">Création Code Parrainage</h2>
                    @csrf

                    <div class="form-contact" style="margin-bottom:20px">
                        <select name="id_remise" id="pet-select"
                            style="margin-left:5%;background-color:#eee;margin-bottom:20px;width:385px;height:50px;float:left;border-radius:4px;">
                            <option value="" selected>Choisissez une remise </option>
                            @foreach ($remises as $rem)
                            <option value="{{ $rem->id_remise }}" {{old('id_remise')==$rem->id_remise ? "selected" :
                                ""}}> {{ $rem->id_remise }} - {{ $rem->nom_remise }}
                            </option>
                            @endforeach
                        </select>
                    </div>
                    <div class="form-contact" style="margin-top:20px">
                        <input type="text" name="code" class="form-control" value="old('code')" placeholder="Code"
                            style="width:385px;margin-left:5%;border:2px #888888  solid">
                    </div>
                    <div class="form-contact" style="margin-top:20px">
                        <input type="text" name="nb_utilisation" class="form-control" value="old('nb_utilisation')"
                            placeholder="Nb d'utilisation" style="width:385px;margin-left:5%;border:2px #888888  solid">
                    </div>
        ...
        <div class="code-popup ">
            <form action="{{ route('clients.createcode', ['contact' => $con->id_contact]) }}" method="post">
                <div class="form-code" id="popupFormCode" style="background-color: #c8c7cc">
                    <h2 style="text-align:left">Création Code Promo</h2>
                    @csrf
                    ...
                    <div class="form-contact" style="margin-top:20px">
                        <input type="text" name="nb_utilisation" class="form-control" value=""
                            placeholder="Nb d'utilisation" style="width:385px;margin-left:5%;border:2px #888888  solid">
                    </div>
                    <div style="margin-top:10px">
                        <button type="submit" class="btn btn-primary">Enregistrer</button>
                        <button type="button" class="btn btn-danger" onclick="closeFormCode()">Annuler</button>
                    </div>
                </div>
            </form>
            ...
            <table>
                ...
                <tr>
                    ...
                    @foreach($personas as $index => $persona)
                        <td style="text-align:center">{{ $persona->tag }}
                    @endforeach
        ...
        <tbody>
            ...
            <tr>
                <td><a style="color : blue"
                        href="{{ route('entreprises.show', ['id_organisation'=>$entreprise->id_organisation]) }}">GO</a>
                </td>
...
<div class="profile-container">
    <div class="row row-space-20">
        ...
        <div class="col-md-4 hidden-xs hidden-sm" style="max-width:25%">
            <div class="tab-content p-0">
                <div class="tab-pane active show" id="profile-about">
                    ...
                    <table class="table table-profile" style="margin-top:30px;margin-left:0px">
                        <thead>
                            <tr style="padding:0;">
                                <th style="padding:0;" colspan="2">User Content</th>
                            </tr>


                        </thead>
                    </table>
                    <table style="margin-top:30px;margin-left:10px;width:90%">
                        <tbody>
                            <tr>
                                <td><img class="fit-picture"
                                        src="https://media.istockphoto.com/id/1308644408/fr/photo/jolie-fille-asiatique-prennent-un-autoportrait-avec-son-t%C3%A9l%C3%A9phone-intelligent-selfie.jpg?s=612x612&w=0&k=20&c=J6Qy2_BdpzNtQxw3x1YofwRDgOGYjlVysAVBAZ2E5Cc="
                                        style="width:40px;border:2px solid black;float:left;border-radius:10px"
                                        alt="Grapefruit slice atop a pile of other slices"></td>
                                <td><b style="margin-right:20px">Content 1</b></td>
                                <td style="margin-right:20px">XXXXXXXX</td>
                            </tr>
                            <tr>
                                <td><img class="fit-picture"
                                        src="https://media.istockphoto.com/id/1308644408/fr/photo/jolie-fille-asiatique-prennent-un-autoportrait-avec-son-t%C3%A9l%C3%A9phone-intelligent-selfie.jpg?s=612x612&w=0&k=20&c=J6Qy2_BdpzNtQxw3x1YofwRDgOGYjlVysAVBAZ2E5Cc="
                                        style="width:40px;border:2px solid black;float:left;border-radius:10px"
                                        alt="Grapefruit slice atop a pile of other slices"></td>
                                <td><b style="margin-right:20px">Content 2</b></td>
                                <td style="margin-right:20px">XXXXXXXX</td>
                            </tr>
                            </tr>
                            <tr>
            ...
            <div class="tab-content p-0">
                <div class="tab-pane active show" id="profile-about" style="margin-left:0px;">
                    <table class="table table-profile">
                        <thead>
                            <tr style="padding:0;">
                                <th style="padding:0 0 0 0;" colspan="2">Expérience liée</th>
                            </tr>
                    ...
                    <table style="width: 150%;margin-left:0;">
                        <tbody>
                            <tr>
                                ...
                                <td><b style="margin-right:20px">Type</b></td>
                                <td><b style="margin-right:20px">Num Exp</b></td>
                                <td><b style="margin-right:20px">Statut</b></td>
                                <td><b style="margin-right:20px">Date</b></td>
                                <td><b style="">Facture</b></td>
                            </tr>
                            @foreach ($experiences as $exp)
                            @php
                            if ($exp->profil=="Client")
                            {
                            $type="Achété";
                            }
                            elseif ($exp->profil=="User")
                            {
                            $type="Vécu";
                            }
                            elseif($exp->profil=="Client-User")
                            {
                            $type="Vécu et Achéte";
                            }
                            else
                            ...
                            <tr>
                                <td><b style="color:red"><a
                                            href="{{ route('experience.show', ['id_experience'=>$exp->id_experience,'num_facture'=>$exp->num_facture]) }}">GO</a></b>
                                </td>
                                <td>{{ $type }}</td>
                                <td>{{ $exp->numero_experience }}</td>
                                <td>{{
                                    $statut_experience->firstWhere('id_experience',$exp->id_experience)->statut_experience
                                    }}</td>
                                <td>
                                    <div style="width:80px "> {{
                                        Carbon\Carbon::parse($statut_experience->firstWhere('id_experience',$exp->id_experience)->date_statut
                                        )->format('Y m d')}}</div>
                                </td>
                                <td>N° {{ $exp->num_facture }}</td>
                            </tr>
                            @endforeach
                    ...
                    <table style="width: 230%;margin-top:50px;margin-left:s0px">
                        <thead>
                            <tr>
                                <th colspan="2" style="padding:3rem 0 1rem 0"><b style="font-size:2.5em;">Content
                                        Storytelling </b>
                                    <svg style="cursor:pointer; " onclick="openStory()"
                                        ...
                                        <g id="Groupe_3" data-name="Groupe 3" transform="translate(-505.039 -340.955)">
                                            ...
                                            <rect id="Rectangle_1" data-name="Rectangle 1" width="4" height="15.055"
                                                rx="2" transform="translate(513.039 343.428)" fill="#fff" />
                                            <rect id="Rectangle_2" data-name="Rectangle 2" width="3.998" height="15.622"
                                                rx="1.999" transform="translate(522.85 348.956) rotate(90)"
                                                fill="#fff" />
                                        </g>
                                    </svg>
                                </th>
                            ...
                            <form method="post">
                                ...
                                <tr style="float:left ;border-radius:10px;">
                                    <td style=" text-align: justify;padding:0.5rem">
                                        ...
                                        @endif
                                        @endforeach
                                        <pre style="width:550px; margin:0; white-space: pre-line;">
                                                    {{ $story->description }}
                                                </pre>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="text-align:center">
                                        ...
                                        <!-- ------------------------------------- -->
                                        <button
                                            formaction="/contacts.destroystorytelling/{{ $story->id_storytelling }}/{{ $con->id_contact }}"
        ...
        <div class="col-md-4 " style="max-width:25%">
            <div class="tab-content p-0">
                <div class="tab-pane active show" id="profile-about" style="width:120%;margin-left:0px">
                    <table class="table table-profile" style="margin-bottom:25px">
                        <thead>
                            <tr style="padding:0;">
                                <th style="padding:0;" colspan="2">Contacts liés </th>
                            </tr>


                        </thead>
                    </table>
                    <table style="margin-top:-8px;margin-bottom:40px;width:60%">
                        <tbody>
                            <tr>
                                <td><b style="margin-right:20px">ID</b></td>
                                <td><b style="margin-right:20px">Nom</b></td>
                                <td><b style="margin-right:20px">Prénom</b></td>
                                <td><b style="margin-right:20px"></b></td>
                            </tr>


                            @foreach ($contacts_liees as $contact)
                            <tr>
                                <td>{{ $contact->id_contact }}</td>
                                <td>{{ $contact->nom }}</td>
                                <td>{{ $contact->prenom }}</td>
                                <td><b style="color:red"><a href="/contacts.show/{{$contact->id_contact}}">GO</a></b>
                                </td>
                            </tr>
                            @endforeach
                                        ...
                                        <ul class="tl">
                                            ...
                                            <li class="tl-item" ng-repeat="item in retailer_history"
                                                ...
                                                <div class="timestamp"
                                                    ...
                                                    {{ Carbon\Carbon::parse($event->date_creation )->format('Y m d')}}
                                                    <br>
                                                </div>
                                                <div class="item-title"
                                                    style="padding:0 3rem 0 0;font-size:0.7em;color:#333333;width:200px">
                                                    <b>Evénement {{ $loop->index+1 }}</b> : {{
                                                    $event->contenu_notification }} </div>
    ...
    <!-- --------------------- interactions ------------------- -->
    <table class="table table-profile" style="margin:0;margin-left:-550px; margin-top: -275px">
        <thead>
            <tr>
...
<script>
    // Ilham
    // function openIntPersonna() {
    //     var div_int_form = document.getElementById("persoForm");
    // div_int_form.style.display = "block";
    // suggestion_tag_personna(div_int_form);
    ...
    // suggestion_tag_personna_update(searched_tag, div_affichage, zone_affichage_dans_barre);
    ...
    function openFormCode() {
        document.getElementById("popupFormCode").style.display = "block";
    }

    function closeForm() {
        document.getElementById("popupForm").style.display = "none";
    }
    function closeFormCode() {
        document.getElementById("popupFormCode").style.display = "none";
    }
    //******************** yasser *****************************
...
//Ilham
function affiche_checkbox_tag(tagText, tagId, divAffichage, zoneAffichageBarre) {
    // Créez un élément de bouton
    var tagButton = document.createElement("button");
    tagButton.className = "tag-button"; // Vous pouvez définir une classe CSS pour styliser le bouton
    tagButton.innerHTML = tagText;
    
    // Attachez un attribut personnalisé pour stocker l'ID du tag
    tagButton.setAttribute("data-tag-id", tagId);

    // Ajoutez le bouton au div d'affichage
    divAffichage.appendChild(tagButton);

    // Écoutez l'événement de clic sur le bouton pour le supprimer lorsqu'il est cliqué
    tagButton.addEventListener("click", function () {
        divAffichage.removeChild(tagButton);
        // Vous pouvez également ajouter ici la logique pour supprimer le tag de la base de données ou d'autres actions
    });

    // Ajoutez également le bouton au div d'affichage en bas de la barre de recherche
    var tagButtonBarre = tagButton.cloneNode(true); // Créez une copie du bouton
    tagButtonBarre.removeAttribute("data-tag-id"); // Supprimez l'attribut personnalisé
    zoneAffichageBarre.appendChild(tagButtonBarre);
}
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            if (response.length > 0) {
                                div_affichage.innerHTML = "";
                                response.forEach( function(un_tag) {
                                    // affiche_checkbox_tag(un_tag.tag, un_tag.id_tag_personnas,div_affichage, zone_affichage_dans_barre  )
...
<div class="formclt">
    <div class="form-int" id="intForm">
        <form action="{{ route('contacts.createinteraction') }}" method="post" class="form-container">
            @csrf
            <h4 style="text-align:start;margin-top:30px">Ajouter une nouvelle interaction liée au contact </h4>
            ...
            <!-- -------------------------tags--------------- -->
            <div
                style="width: 100%; background-color: white; border: 2px black solid; border-radius: 4px; margin: 0; resize: none; overflow: hidden;">
            ...
            <div class="form-contact" style="margin-top:20px">
                ...
                <textarea name="texte" class="form-control" cols="30" rows="5" value="{{old('texte')}}"
                    placeholder="Texte de l'Interaction"
                    style="background-color:white;border:2px black  solid  ; margin-bottom:3px"></textarea>
            </div>
    ...
    <div class="form-story" id="storyForm">
        <form action="{{ route('contacts.createstorytelling') }}" method="post" class="form-container">
            @csrf
            <input type="hidden" id="id_contact" name="id_contact" value="{{old('id_contact') ?? $con->id_contact }}">
            ...
            <div
                ...
                <input style="margin:0; background:none;" placeholder="Cherchez un tag" type="text"
                    id="select_tag_story">
            </div>
            ...
            <div class="form-contact" style="margin-top:20px">
                ...
                <textarea name="desc_story" class="form-control" cols="30" rows="5" value="{{old('desc_story')}}"
                    placeholder="Description Storytelling"
                    style="background-color:white;border:2px black  solid; margin-bottom:3px"></textarea>
            </div>
