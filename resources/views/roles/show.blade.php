...
@section('content')
<div class="container">
<h2 style="margin-bottom :25px">Role</h2>
...
<div id="content" class="content p-0">
    <div class="profile-header">
        ...
        <div class="profile-header-content">
            ...
            <div class="profile-header-info">
                <h4 class="m-t-sm">{{$role->name}}</h4>
                <p class="m-b-sm">ID  :  {{$role->id}}</p>
        <br><br><br>
            </div>
        </div>
    </div>
    ...
    <div class="profile-container">
        ...
        <div class="h-100 d-flex align-items-center justify-content-center">
                ...
                <a href="{{ route('roles.edit',$role->id) }}" style="margin-left : 6px " class="btn btn-warning">Edit</a>
