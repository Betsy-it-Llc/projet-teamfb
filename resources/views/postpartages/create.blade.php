                ...
                <div class="row gutters">
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                        <div class="form-group">
                            ...
                            <textarea name="message_personnalise" class="form-control" placeholder="Message personnalisé"  style=" white-space: pre-line; border:1px #cfd1d8 solid;"  rows="5"></textarea>
