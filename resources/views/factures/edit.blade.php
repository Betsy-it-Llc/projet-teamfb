...
@section('content')
    ...
    @endif
    <div class="container">
        <h2 style="margin-bottom:30px">Edit une facture</h2>
            <div class="main-body">
                <div class="row">
                    <div class="col-lg-4">
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex flex-column align-items-center text-center">
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <a href="{{ route('facture.show',['facture'=>$facture]) }}"><button class="btn btn-outline-primary">More info</button></a>
                                    </div>
                                </div>
                                <hr class="my-4">
                                <ul class="list-group list-group-flush">
                                    ...
                                    <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                    <h6 class="mb-0">nb_experiementateur :</h6>
                                        <span class="text-secondary"></span>
                                    </li>
                                    <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                    ...
                    <div class="col-lg-8">
                    <form action="{{ route('factures.update',['facture'=>$facture]) }}" method="POST">
                    @csrf
                    @method('PUT')
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row mb-3">
                                    <div class="col-sm-3">
                                        <h6 class="mb-0">nbexperimentateur</h6>
                                    </div>
                                    <div class="col-sm-9 text-secondary">
