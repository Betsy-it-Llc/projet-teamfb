    ...
    <h2 style="margin-bottom:30px">Validation Facture</h2>
		<div class="main-body">
			<div class="row">
						...
						<div class="card-body">
							<div class="d-flex flex-column align-items-center text-center">
								...
								<div class="mt-3">
									...
									<a href="{{ route('factures.show') }}"><button class="btn btn-outline-primary">More info</button></a>
								</div>
							</div>
							<hr class="my-4">
				...
				<div class="col-lg-8">
                <form action="{{ route('factures.update') }}" method="POST">
                @csrf
                @method('PUT')
					<div class="card">
						<div class="card-body">
                            ...
                            <div class="row mb-3">
								...
								<div class="col-sm-9 text-secondary">
                                <input type="text" name="statut_experience" class="form-control" value="{{old('statut_experience{{old('')}}')}}">
                				</div>
							</div>
                            <div class="row mb-3">
								<div class="col-sm-3">
