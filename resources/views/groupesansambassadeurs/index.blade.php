...
<!-- Recherche multicritère -->
            <section class="search-sec" style="margin : 20px ; font-size : 13px">
                ...
                <h6>Recherche multicritère</h6>
                    <form action="{{ route('multisearch_sans_amb') }}" method="get" novalidate="novalidate">
                    <div class="row">
                            <div class="col-lg-40">
                                <div class="row">
    ...
    <p> Il y'a : {{ $groupesansambassadeurs->total() }} Groupes</p>
        <table class="table">
            ...
            <tr>
                ...
                <td>
                    <form action="{{ route('groupesansambassadeurs.destroy',$value->id_groupe) }}" method="POST">
                    <a style="background-color : #fafafa ; border : #fafafa" class="btn btn-info" href="{{ route('groupes.show',$value->id_groupe) }}"><i style="color : black" class="fas fa-info"></i></a>

   <a style="background-color : #fff ; border : #fff" class="btn btn-primary"
                                    href="{{ route('groupes.edit', $value->id_groupe) }}"><i style="color : #e6ac00"
        ...
        {!! $groupesansambassadeurs->appends(request()->query())->links() !!}
    </div>
    <style>
#pageSubmenu{
visibility:visible;
