...
@section('content')
<title>Modification Pack</title>
<div class="container">
        <form action="{{ route('packs.update') }}" method="post">
            @csrf
            @method('put')
            <input type="hidden" id="id_pack" name="id_pack" value="{{ $packs }}"> 
            @if($errors->any())
        ...
        <div class="col-xl-3 col-lg-3 col-md-12 col-sm-12 col-12" style="margin-left:50px">
            <div class="card h-100" style="width:450px;margin-left:50px">
                <div class="card-body" style="height:400px;">
                    <center> <h1 style="margin-bottom:40px"> Modification de Pack</h1>
        ...
        <div class="col-xl-3 col-lg-3 col-md-12 col-sm-12 col-12" >
            <div class="card h-100" style="width:420px;margin-left:300px">
                ...
                <div class="form-contact" style="margin-top:20px;">
                    ...
                    </div><b style="float:left;font-size:1.7em">{{$pack->statut}}</b>
                    <div class="form-contact" style="margin-top:20px">
                            <input type="text" name="nom" class="form-control"  placeholder="Nom" value="{{$pack->nom}}" value="{{old('nom')??$pack->nom}}">
                    </div>
                    ...
                    <div class="form-contact" style="margin-top:20px">
                            <input type="text" name="abstract" class="form-control"  placeholder="Abstract" value="{{old('abstract')??$pack->abstract}}">
                    </div>
                    <div class="form-contact" style="margin-top:20px">
                    ...
                    <div class="form-contact" style="">
                        <!-- <input type="text" name="description" class="form-control" value="{{old('description')}}" style="height:120px" value="{{$pack->description}}"> -->


                        <textarea name="description" class="form-control" style="height:120px" cols="30" rows="5"> {{old('description')??$pack->description}} </textarea>
                    </div>
                    <div class="form-contact" style="margin-top:20px;">
                    ...
                    <a class="btn btn-danger" href="{{ route('packs.index') }}"> Annuler</a>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        allPricesSelect.addEventListener('change', function() {
            ...
            var prix = selectedOption.textContent.split('Prix : ')[1].split(' - Statut : ')[0].trim();
