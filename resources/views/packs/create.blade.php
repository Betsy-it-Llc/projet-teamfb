        ...
        <div class="col-xl-3 col-lg-3 col-md-12 col-sm-12 col-12" style="margin-left:50px">
            <div class="card h-100" style="width:450px;margin-left:50px">
                <div class="card-body" style="height:400px;">
                    <center> <h1 style="margin-bottom:40px"> Création de Pack</h1>
            ...
            <div class="card h-100" style="width:420px;margin-left:300px">
                <div class="card-body"style="margin-right:0px">
                    ...
                    <div class="form-contact" >
                        <!-- <input type="text" name="description" class="form-control" value="{{old('description')}}" style="height:120px"> -->
                        <textarea name="description" class="form-control" style="height:120px" cols="30" rows="5">{{old('description')}} </textarea>
                    </div>
