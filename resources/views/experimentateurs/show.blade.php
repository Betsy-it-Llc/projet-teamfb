...
@endif
    ...
    <div id="content" class="content p-0" >
        ...
        <center>
            <b style="margin-bottom :20px;font-size:2.5rem;"> Info Expérimentateur </b>
        </center>
        ...
        <table>
                <tr>
                    ...
                    <div class="code-popup ">
                        {{-- <form action="{{ route('clients.createcodeparrain') }}" method="post"> --}}
                    ...
                    <div class="profile-header-name" >
                           <table>
                            ...
                            <tr>
                            <td style="text-align:right;width:40%"><b>Personna : </b></td>
        ...
        <div class="profile-container">
            <div class="row row-space-20">
                ...
                <div class="col-md-4 hidden-xs hidden-sm" style="max-width:25%">
                    ...
                    <!-- ------------------------ Info Client  ----------------- -->
                            <table class="table table-profile" style="margin-left:-50px; ">
                                <thead>
                                    ...
                                    <tr style="font-size:1rem;">
                                       <td style="padding:0rem 0;"><b> Id :{{ $con->id_contact }}</b></td>
                                    </tr>
                                </thead>
                    ...
                    <!-- ------------------------ Info Client : fin ----------------- -->
                    <!-- ------------------------ Intéractions  : ----------------- -->
                            <table class="table table-profile" style="">
                                <thead>
                                    <tr>
                                ...
                                <tbody >
                                    <tr style="padding:0;">
                                        <td style="padding:0;">
                                            <div class="history-tl-container" style="margin-top:15px; line-height:1.5em; /*min-width:920px;*/ ">
                                            <form method="post">
                                            @csrf
                                            @method('DELETE')
                                                <ul class="tl">
                                                    ...
                                                    <li class="tl-item" ng-repeat="item in retailer_history" style="padding:0 0 2rem 2rem ">
                                                        <div class="timestamp" style="padding:0 0 0 0;font-size:0.75em;color:#333333; width:100px; ">
                                                                {{ Carbon\Carbon::parse($int->date_heure)->format('Y m d') }}
                                                                <button formaction="/experimentateurs.destroyinteraction/{{ $int->id_interaction }}/{{ $con->id_contact }}"
                                                                    style="background:none ; border : none; font-size:0.85rem;" type="submit" class="btn btn-danger"
                                                                    onclick="return confirm('Are you sure you want to delete ?')"><i
                                                                        style="color : red" class="fas fa-trash"></i></button>
                                                                <br>
                                                                {{ Carbon\Carbon::parse($int->date_heure)->format('H:i') }}
                                                        </div>
                                                        <div class="item-title" style="padding:0 1rem 0 0;color:#333333;width:200px; display:flex; ">
                                                            <div  class="btn_upd_int btn btn-primary"  data-value="{{ $int->id_interaction }}" style="background-color : #fff ; border : #fff;font-size:0.85rem; margin-right:-10px;">
                                                                <i style="color : #e6ac00" class="fas fa-edit  "></i>
                                                            </div>
                                                            <div>
                                                                @foreach($les_tags_lier_avec_inter as $tags)
                                                                    @if($tags->id_interaction == $int->id_interaction)
                                                                    {{ $tags->tag }} |
                                                                    @endif
                                                                @endforeach
                ...
                <!-- ----------- col 2 --------- -->
                <div class="col-md-4 hidden-xs hidden-sm" style="max-width:20%">
                    <div class="tab-content p-0">
                        <div class="tab-pane active show" id="profile-about">
                    <!-- ------------------------ Contacts liés  ----------------- -->
                            <table class="table table-profile" style="margin-bottom:25px">
                                ...
                                <table style="margin-top:-8px;margin-left:10px;width:60%">
                                    <tbody>
                                    <tr>
                                ...
                                @foreach ($contacts_liees as $con)
                                <tr >
                                    <td>{{ $con->id_contact }}</td>
                                    <td>{{ $con->nom }}</td>
                                    <td>{{ $con->prenom }}</td>
                                    <td><b style="color:red"><a href="/contacts.show/{{$con->id_contact}}">GO</a></b></td>
                    ...
                    <!-- ------------------------ Contacts liés : fin  ----------------- -->
                    <!-- ------------------------ Intéraction Storytelling  ----------------- -->
                            <table style="width: 300%;margin-left:30px">
                                   <thead>
                                        <tr>
                                            <th colspan="2" style="padding:3rem 0 1rem 10rem;color:black"><b style="font-size:2.2em;">Intéraction Storytelling </b>
                                    ...
                                    @foreach ($storytelling as $story)
                                        ...
                                        <tr>
                                            <td style="text-align:center">
                                                ...
                                                <!-- ------------------------------------- -->
                                                <button formaction="/experimentateurs.destroystorytelling/{{ $story->id_storytelling }}/{{ $con->id_contact }}"
            ...
            <!-- ------------------------ Expérience liée  ----------------- -->
                <div class=" " style="max-width:25%">
                    <div class="tab-content p-0">
                        <div class="tab-pane active show" id="profile-about" style="margin-left:35px;width:130%">
                        ...
                        <table class="table table-profile">
                            ...
                            <table style="width: 110%;margin-left:0;">
                                <tbody >
                                <tr>
                                <td><b style="margin-right:20px">ID</b></td>
                                ...
                                <td><b style="margin-right:20px">Lieu</b></td>
                                </tr>
                                ...
                                <tr >
                                    ...
                                    <td><b style="color:red"><a href="{{  route('experience.show', ['id_experience'=>$exp->id_experience,'num_facture'=>$exp->num_facture])  }}">GO</a></b></td>
                                    <td> {{ $exp->prix_facture }} € </td>
                                    <td>??????</td>
                                </tr>
                                @endforeach
                                </tbody>
            ...
            <!-- ------------------------ Expérience liée : fin  ----------------- -->
                    ...
                    <div class="tab-content p-0">
                        <div class="tab-pane active show" id="profile-about" style="margin-top:-50px;margin-left:150px;width:160%">

                    <!-- ------------------------ Evénements  ----------------- -->
                            <table class="table table-profile" style="margin-left:30px;">
                                <thead>
                                    <tr>
                                    <th style="padding:0 0 1rem 0;"  colspan="2">Evénements </th>
                                    </tr>
                                </thead>
                                <tbody >
                                    <tr style="padding:0;">
                                    ...
                                    <ul class="tl" >
                                        ...
                                        <li class="tl-item" ng-repeat="item in retailer_history" style="padding:0 0 2rem 2rem">
                                            <div class="timestamp" style="padding:0 2rem 0 0;font-size:1em;color:#333333">{{ Carbon\Carbon::parse($event->date_creation)->format('Y m d')}}
                                            <br>
                                            </div>
                                            <div class="item-title" style="padding:0 2rem 0 0;font-size:0.7em;color:#333333;width:200px"><b>View {{ $loop->index+1 }}</b> {{ $event->contenu_notification }} </div>
                    ...
                    <!-- ------------------------ Evénements  ----------------- -->
                    <!-- ------------------------ User Content  ----------------- -->
                            <table class="table table-profile" style="margin-top:-30px;margin-left:30px">
                                    <thead>
                                    <tr style="padding:0;">
                                ...
                                <table style="margin-top:30px;margin-left:30px;width:60%">
                                    <tbody>
                                <tr>
                                <td><img class="fit-picture" src="https://media.istockphoto.com/id/1308644408/fr/photo/jolie-fille-asiatique-prennent-un-autoportrait-avec-son-t%C3%A9l%C3%A9phone-intelligent-selfie.jpg?s=612x612&w=0&k=20&c=J6Qy2_BdpzNtQxw3x1YofwRDgOGYjlVysAVBAZ2E5Cc=" style="width:40px;border:2px solid black;float:left;border-radius:10px" alt="Grapefruit slice atop a pile of other slices"></td>
...
<div class="formclt">
    ...
    <div class="form-int" id="intForm">
        <form action="{{ route('experimentateurs.createinteraction') }}" method="post" class="form-container">
            @csrf
            <h4 style="text-align:start;margin-top:30px">Ajouter une nouvelle interaction liée à l'experimentateur </h4>
            <input type="hidden" id="id_contact" name="id_contact" value="{{old('id_contact') ?? $con->id_contact }}">
    ...
    <div class="form-story" id="storyForm">
        <form action="{{ route('experimentateurs.createstorytelling') }}" method="post" class="form-container">
            @csrf
            <input type="hidden" id="id_contact" name="id_contact" value="{{old('id_contact') ?? $con->id_contact }}">
            ...
            <div class="form-contact" style="margin-top:20px">
                ...
                <textarea id="myTextarea" name="desc_story" class="form-control" cols="30" rows="5" value="{{old('texte')}}" placeholder="Texte de l'Interaction" style="white-space: pre-line; background-color:white;border:2px black  solid  ; margin-bottom:3px"></textarea>
            </div>
            <button type="submit" class="btn" style="width:100px">Enregistrer</button>
...
.history-tl-container ul.tl li{
   list-style: none;
 /* -----------------------------yasser : jenleve les 120px de margin--------------------------------- */
   /* margin-left:120px; */
/* ----------------------------- yasser fin ------------------------------ */
   /*background: rgba(255,255,0,0.1);*/
   border-left:3px solid  black;
