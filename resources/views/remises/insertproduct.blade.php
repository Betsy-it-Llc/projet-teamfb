...
<div class="container">
    <form action="{{ route('remises.addproduct') }}" method="post">
        @csrf
        ...
        <div class="col-xl-3 col-lg-3 col-md-12 col-sm-12 col-12" style="margin-left:50px">
            <div class="card h-100" style="width:450px;margin-left:50px">
                <div class="card-body" style="height:400px;">
                    <center> <h1 style="margin-bottom:40px"> Ajout d'un produit à la Remise</h1>
            ...
            <div class="card h-100" style="width:420px;margin-left:300px">
                ...
                <div class="form-contact" style="margin-top:20px;">
                    ...
                    <div class="form-contact" style="margin-top:20px">
                        ...
                        <select name="id_produit" id="pet-select" style="margin-left:0px;background-color:white;margin-bottom:20px;width:305px;height:50px;float:left;border-radius:4px;">
                            <option value="">Choisissez un produit </option>
                            @foreach ($nom_prod as $prod)
                            <option value="{{ $id_prod[$loop->index] }}" {{ old('id_produit') == $id_prod[$loop->index] ? "selected" : "" }} >{{ $prod }}</option>
                            @endforeach
                        </select>                    </div>
                    <div class="form-contact" style="margin-top:20px">
