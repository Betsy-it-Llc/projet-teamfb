...
<section class="search-sec" style="margin : 20px ; font-size : 13px">
    <div class="container">
        ...
        <form action="{{ route('multisearch_camp') }}" method="get" novalidate="novalidate">
        <div class="row">
                <div class="col-lg-50">
                    <div class="row">
                        <div class="">
    ...
    <form method="post">
        ...
        <table class="table">
            ...
            <tr>
                ...
                <td>
                        <a style="background-color : #fff ; border : #fff" class="btn btn-info" href="{{ route('groupecampagnes.index',['id_campagne'=>$value->id_campagne]) }}"><i style="color : #4d94ff" class="fas fa-eye"></i></a>
