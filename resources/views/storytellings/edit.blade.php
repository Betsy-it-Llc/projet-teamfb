...
@section('content')
<title>Modification Storytelling</title>
<div class="container">
        <form action="{{ route('storytellings.update') }}" method="post">
            @csrf
            @method('put')
            <input type="hidden" id="id_storytelling" name="id_storytelling" value="{{ $story->id_storytelling }}">
            @if($errors->any())
    ...
    <div class="row gutters">
        ...
        <div class="col-xl-3 col-lg-3 col-md-12 col-sm-12 col-12" >
            <div class="card h-100" style="width:420px;margin-left:350px">
                ...
                <center> <h1 style="margin-bottom:40px"> Modification Storytelling</h1>  
                ...
                <b style="font-size:1.2em;color:brown"></b><br>
                    ...
                    <div style="width: 100%; background-color: white; border: 2px black solid; border-radius: 4px; margin: 0; resize: none; overflow: hidden;" >
                        ...
                        <input  style="margin:0; background:none; width:100%" placeholder="Cherchez un tag" type="text" id="select_tag_story" >
                    </div>
                    <div id="affichage_tag_selected_story" style="border-radius:4px; padding:10px;  "></div>
                    <!-- -------------------------tags--------------- -->
                    <div class="form-contact" style="margin-top:20px; text-align:left;">
                        <label for="desc_story">Description Storytelling</label>
                        <!-- <input type="text" name="desc_story" class="form-control" value="{{old('desc_story')}}"  placeholder="Description Storytelling" style="white-space: pre-line; width:385px;border:2px #888888  solid;margin-bottom:50px"> -->
                        <textarea name="desc_story" class="form-control"  placeholder="Description Storytelling" style="white-space: pre-line; width:385px;border:2px #888888  solid;margin-bottom:50px" cols="30" rows="5">{{ $story->description }}
                        </textarea>
                    </div>
...
<script>
    $(document).ready(function() {
        var searched_tag                = document.getElementById('select_tag_story');
        var div_affichage               = document.getElementById('affichage_tag_selected_story');
        var zone_affichage_dans_barre   = document.getElementById('tag_selectionned_story');
        var id_storytelling_to_edit      = "{{$story->id_storytelling}}";
        var data = @json($les_tags_lier_avec_story);
        // --------------------
        data.forEach(function(element) {
            if(element.id_storytelling == id_storytelling_to_edit){
                console.log(element);
                ...
                checkbox.value = element.id_tag_story;
        ...
        suggestion_tag_story_update(searched_tag, div_affichage, zone_affichage_dans_barre )
    });
