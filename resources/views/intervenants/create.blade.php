...
@section('content')
<title>Create Intervenant</title>
<div class="container">
        ...
        <div class="col-xl-3 col-lg-3 col-md-12 col-sm-12 col-12" style="margin-left:50px">
            <div class="card h-100" style="width:450px;margin-left:50px">
                <div class="card-body" style="height:600px;margin-bottom:-40px">
                    <center> <h1 style="margin-bottom:60px"> Création d'Intervenant</h1>
        ...
        <div class="col-xl-3 col-lg-3 col-md-12 col-sm-12 col-12" >
            <div class="card h-100" style="width:420px;margin-left:300px">
                <div class="card-body"style="margin-top:60px;margin-right:0px">
                    ...
                    <select name="id_cnt" id="pet-select" style="background-color:white;margin-bottom:20px;width:340px;height:35px;float:left;border-radius:4px;border-color:black">
                        <option value="" selected>Créer un nouveau contact</option>
                        @foreach ($nom_con as $con)
                        <option value="{{ $id_con[$loop->index] }}"{{old('id_cnt') == $id_con[$loop->index] ? "selected" : ""}}> {{ $id_con[$loop->index] }} - {{ $con }}</option>
                        @endforeach
                    ...
                    @endphp
                    <div class="form-contact" style="margin-top:20px">
                        <input type="text" name="role" class="form-control" value="{{old('role')}}"  placeholder="Rôle*">
                    </div>
                    <div class="form-contact" style="margin-top:20px">
                            <input type="text" name="Nom" class="form-control" value="{{old('Nom')}}"  placeholder="Nom*">
                    </div>
                    <div class="form-contact" style="margin-top:20px">
                            <input type="text" name="Prénom" class="form-control" value="{{old('Prénom')}}"  placeholder="Prénom*">
                    </div>
                    <div class="form-contact" style="margin-top:20px">
                    ...
                    <div class="form-contact" style="margin-top:20px">
                            <input type="text" name="tarif_fixe" class="form-control" value="{{old('tarif_fixe')}}"  placeholder="Tarif fixe">
                    </div>
                    <div class="form-contact" style="margin-top:20px">
                            <input type="text" name="tarif_horaire" class="form-control"value="{{old('tarif_horaire')}}"  placeholder="Tarif horaire">
                    </div>
                    ...
                    <a class="btn btn-danger" href="{{ route('contacts.create') }}"> Annuler</a>
                    </div>
                </div>
            </div>
        </div>
