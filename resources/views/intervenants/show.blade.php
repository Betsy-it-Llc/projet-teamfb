...
<link rel="shortcut icon" href="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS4xj0iSqUrByq6k1TGf6Z8AoRg1tGXUujma2RKRTpBkWzEGXRdn1RvvSgKOJGPvDIQgJc&usqp=CAU" />
</head>
<div class="container"  style="width:100%;margin:0">
    ...
    <div id="content" class="content p-0" >
        <div class="profile-header">
            <center>
                <b style="margin-bottom :20px;font-size:2.5rem;">Info Intervenant</b>
            </center>      
        </div>
        <br>
                ...
                <tr>
                        ...
                        <div class="profile-header-content">
                            <form method="post">
                                ...
                                <div class="profile-header-img" style="background:none;height:110%">
                                        ...
                                        href="{{ route('intervenants.edit', $con->id_intervenant_) }}"><i style="color : green;"
                                            class="fas fa-edit fa-lg"></i></a>
                                        <button formaction="{{ route('intervenants.destroy', $con->id_intervenant_) }}"
                    ...
                    <td>
                        ...
                        <div class="profile-header-name" >
                            <table>
                                @php
                                    if (!empty($con_entreprise)) {
                                        $role=$con_entreprise->role_;
                                        $num_cse=$con_entreprise->num_cse;
                                    }
                                    else {
                                        $role="";
                                        $num_cse="";
                                ...
                                <tr>
                                    <td style="text-align:right;width:40%"><b>Spécialité : </b></td>
        ...
        <div class="profile-container">
            <div class="row row-space-20">
                <div class="" style="max-width:20%">
                    <div class="tab-content p-0">
                        <div class="tab-pane active show" id="profile-about">
                            <table class="table table-profile" style="margin-left:-30px; ">
                                <thead>
                                    <tr style="padding:0;">
                                        <th style="padding:0;"  colspan="2">Description  <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#editDescriptionModal">
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="{{ route('intervenants.updatedesc') }}" method="POST">
                                                        @csrf
                                                
                                                        <input type="hidden" id="id_contact" name="id_contact" value="{{ $con->id_contact }}"> 
                                                        <input type="hidden" id="id_intervenant_" name="id_intervenant_" value="{{ $url }}"> 

                                                        <div class="form-group">
                                                            <label for="description">Description</label>
                                                            <textarea class="form-control" id="description" name="description" rows="3">{{ $descript }}</textarea>
                                                        </div>
                                ...
                                <tbody>
                                    <tr style="float:left;width:130%">
                                       
                                       
                                    <td style="text-align: justify;padding:0.5rem">
                                        
                                        @if (!empty($descript))
                                        <pre style="white-space: pre-line; text-align:left; margin:0; width: 100%; ">{{ $descript}}</pre>
                                   @else
                                   Il n'y a a pas de description
                                        @endif
                            ...
                            <div class="infoEntreprise" style="position: absolute;top:20%;left:80%">
                            ...
                            <!-- <div class="h-100 d-flex align-items-center justify-content-center" style="width:fit-content;">
                            </div> -->
                            <!-- deplacer le block interaction dans la première colonne -->
                            <!-- ---------------------------Intéractions--------------------------- -->
                            <table class="table table-profile" style="margin-top: 50px;">
                                <thead>
                                    <tr>
                                ...
                                <tbody >
                                    ...
                                    <div class="history-tl-container" style="line-height:1.5em;  ">
                                    ...
                                    <ul class="tl" >
                                        ...
                                        <li class="tl-item" ng-repeat="item in retailer_history" style="padding:0 0 2rem 2rem">
                                            <div class="timestamp" style="padding:0 0 0 0;font-size:0.75em;color:#333333; width:100px; text-align:left;">                                                            
                                                ...
                                                <!-- bouton suppression pas fonctionel !  -->
                                                <button formaction="/intervenants.destroyinteraction/{{ $int->id_interaction }}/{{$url}}"
                                                    style="background:none ; border : none;" type="submit" class="btn btn-danger"
                                                    onclick="return confirm('Are you sure you want to delete ?')"><i
                ...
                <div class="hidden-xs hidden-sm" style="max-width:22%">
                    <div class="tab-content p-0">
                        <div class="tab-pane active show" id="profile-about">
                            <table class="table table-profile" style="margin-left:30px; ">
                                <thead>
                            ...
                            <!-- ancienne place d'interaction  -->
                        </div>
                    </div>
                </div>
                <div class="  hidden-xs hidden-sm" style="max-width:20%">
                    <div class="tab-content p-0">
                        <div class="tab-pane active show" id="profile-about">
                            <table class="table table-profile" style="margin-bottom:1px;margin-left:30px">
                                <thead>
                                    <tr style="padding:0;">
                                        <th style="padding:0 0 1rem 0;"  colspan="2">Performances  </th>
                                    </tr>
                    ...
                    <!-- </table> -->
                            <table class="table table-profile" style="margin-bottom:1px;margin-left:30px">
                                <thead>
                                    <tr style="padding:0;">
                                        <th style="padding:0 0 1rem 0;"  colspan="2">Coùts </th>
                                    </tr>
                                ...
                                <tbody>
                                    <tr>
                                        <td class="field" style="width:90%;">Tarif fixe: </td>
                                        <td class="value">
                                            5
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="field">Tarif horaire: </td>
                                        <td class="value">
                                            7
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="field">Facturé:</td>
                                        <td class="value">
                                        9
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="field">Payé:</td>
                                        <td class="value">
                                        9
                                        </td>
                                    </tr>
                ...
                <!-- --------------------------------Intéraction Storytelling ------------------------------- -->
                            <table class="le_rectangle" style="width: 250%; margin-left:150px ">
                                <thead>
                                    <tr>
                                        <th colspan="2" style="text-align:center; color:black"><b style="font-size:2.2em;">Intéraction Storytelling 
                                    ...
                                    @foreach ($storytelling as $story)
                                        ...
                                        <tr>
                                            <td style="text-align:center">
                                                ...
                                                <!-- ------------------------------------- -->
                                                <button formaction="/intervenants.destroystorytelling/{{ $story->id_storytelling }}/{{$url}}"
                ...
                <div class="" style="max-width:20%">
                    <div class="tab-content p-0">
                        <div class="tab-pane active show le_rectangle" id="profile-about" style="margin-left:35px;width:100%">
                        
                            <table class="table table-profile">
                                <thead>
                                    <tr style="padding:0;">
                                        <th style="padding:0 0 0 0;"  colspan="2">Interventions</th>
                                    </tr>
                                    
                                </thead>
                            </table>
                                
                            <table style="width: 130%;margin-left:0;">
                                <tbody >
                                    <tr>
                                        <td><b style="margin-right:20px">ID</b></td>
                                        <td><b style="margin-right:30px">N° Exp</b></td>
                ...
                <!-- ----------------------------------------------------------------------------------------- -->
                <div class="" style="max-width:18%">
                    <div class="tab-content p-0">
                        <div class="tab-pane active show" id="profile-about" style="margin-left:150px;width:160%">
                            <table class="table table-profile" style="margin-bottom:25px">
                                <thead>
                                    <tr style="padding:0;">
                            ...
                            <table style="margin-top:-8px;margin-left:10px;width:40%">
                                <tbody>
                                    <tr>
                                        <td><b style="margin-right:20px">ID</b></td>
                                    ...
                                    <tr >
                                        ...
                                        <td><b style="color:red"><a href="/contacts.show/{{$contact->id_contact}}">GO</a></b></td>
                                    @endforeach
...
<div class="formclt">
    <div class="form-int" id="intForm">
        <form action="{{ route('intervenants.createinteraction') }}" method="post" class="form-container">
            @csrf
            <h4 style="text-align:start;margin-top:30px">Ajouter une nouvelle interaction liée au intervenant {{ $con->id_contact }}</h4>
            <input type="hidden" id="id_contact" name="id_contact" value="{{ $con->id_contact }}"> 
            <input type="hidden" id="id_intervenant" name="id_intervenant" value="{{ $url }}"> 
    ...
    <div class="form-story" id="storyForm">
        <form action="{{ route('intervenants.createstorytelling') }}" method="post" class="form-container">
            @csrf
            <input type="hidden" id="id_contact" name="id_contact" value="{{ $con->id_contact }}"> 
            <input type="hidden" id="id_intervenant" name="id_intervenant" value="{{ $url }}"> 
            ...
            <div class="form-contact" style="margin-top:20px">
                ...
                <textarea name="desc_story" class="form-control" value="{{old('desc_story')}}" cols="30" rows="5" placeholder="Description Storytelling" style="background-color:white;border:2px black  solid; margin-bottom:3px"></textarea>
            </div>
