...
@section('content')
    ...
    <title>Liste Contributeurs</title>
    <div class="row">
...
@endif
        <div class="col-lg-12" style="margin-bottom : 30px">
            ...
            <center> <tr>
                ...
                <th><b style="font-size:3rem;color:#333333">Contributeurs</b></th>
                <th><b style="font-size:1.5rem;color:#333333">Total :  {{$totalContributeurs}} </b></th>
              </tr><br><br>
                <center>
                        ...
                        <div class="row">
                            <div class="col-lg-40">
                                <div class="row">
                                    ...
                                    <div class="col-lg-2 col-md-2 col-sm-30 p-0">
                                        <input class="form-control" type="text" name="multisearchnom" id="prenom"
                                            placeholder="Prénom">
                                    </div>
                                    <div class="col-lg-2 col-md-2 col-sm-30 p-0">
                                        <input class="form-control" type="text" name="multisearchmail" id="Nombre de projet"
                                            placeholder=" Nombre de Projet">
                                    </div>                   
                                    <div class="col-lg-2 col-md-2 col-sm-30 p-0">
                                        <input class="form-control" type="text" name="multisearchtel" id="date"
                                            placeholder="Date">
                                    </div>
                                    <div class="col-lg-2 col-md-2 col-sm-30 p-0">
                                        <button type="submit" class="btn btn-success wrn-btn"
                                            style="margin-left : 5px">Search</button>
                                        <button type="button" class="btn btn-danger wrn-btn"><aS
                                                href="{{ route('contributeurs.index') }}">Reset</a></button>
                                    </div>
            ...
            <div>
                ...
                <p> Il y'a : {{$totalContributeurs}} Contributeurs
                </p>
            </div>
        </div>
    </div>
            ...
            <table class="table" style="text-align:center">
                <thead class="thead" style="background:#cccccc">
                    <tr style=" white-space: nowrap;">
                        ...
                        <!-- <th>N°</th> -->
                        <th>ID</th>
                        <th>@sortablelink('Contributeur')</th>
                        <th>@sortablelink('Nbr Projet')</th>
                    ...
                    <tr>
                        <th scope="row"><input type="checkbox" name="ids[]" class="selectbox"
                                    value="{{$contributeur->contact->id_contact}}"></th>
                            <td> <a href="#"target="_blank">{{$contributeur->contact->id_contact}}</a></td>
                            <td>{{$contributeur->contact->nom}} {{$contributeur->contact->prenom}}</td>

                            <td>{{ $contributeur->total_projets }}</td>
                            <td>{{ $contributeur->getDateContributionPlusRecenteAttribute() }}</td>
                            <td>{{ $contributeur->total_montant }}</td>

                            <td>
                                <a style="background-color : #fff ; border : #fff" class="btn btn-info"
                                href="{{ route('contributeurs.show', ['id_contact' => $contributeur->contact->id_contact]) }}">
                                <i style="color : #4d94ff" class="fas fa-info"></i>
                            </a>
