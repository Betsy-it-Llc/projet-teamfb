...
<head>
    <title>{{$contributeur->contact->nom}} {{$contributeur->contact->prenom}} </title>
...
<div class="container" style="width:100%;margin:0">
    ...
    <div id="content" class="content p-0">
        <div class="profile-header">
            <center>
                <b style="margin-bottom :20px;font-size:2.5rem;">Info Contributeur</b>
            </center>
                            ...
                            <div class="profile-header-content">
                                <div class="profile-header-img" style="background:none;height:110%">
                                    ...
                                    <a style="background: none ; border : none;margin-left:10px" class="btn btn-primary"
                                        href="/contributions.edit/id"><i style="color : green;"
                                            class="fas fa-edit fa-lg"></i></a>

                                    <button formaction="contributions.destroy/id"
    ...
    <td>
        <div class="profile-header-name">
            <table>
                    ...
                    <b style="font-size:2.3em;">{{$contributeur->contact->nom}} {{$contributeur->contact->prenom}} {{$contributeur->contact->pseudo}} {{ $totalMontant }} Euros </b>
                
                <tr>
                    <td style="text-align:right;width:40%"><b>id contact : </b></td>
                    <td style="text-align:center">{{$contributeur->contact->id_contact}} </td>

                </tr>
                <tr>
                    <td style="text-align:right;width:40%"><b>Persona :</b></td>
            
                        <td style="text-align:center">persona xxx
                  
                </tr>
                <tr>
                    <td style="text-align:right;width:40%"><b>Profil : </b></td>
                    <td style="text-align:center">Profil xxxxx</td>
                </tr>
            </table>
    </td>
                    ...
                    <table class="table table-profile">
                        <thead>
                            ...
                            <tr style="font-size:1rem;">
                                <td style="padding:0 0 0.5rem 0;"><b> Id : {{$contributeur->contact->id_contact}}</b></td>
                            </tr>
                        </thead>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="value">
                                    {{$contributeur->contact->nom}}
                                </td>
                            </tr>
                            <tr>
                                <td class="field">Prenom: </td>
                                <td class="value">
                                    {{$contributeur->contact->prenom}}
                                </td>
                            </tr>
                            <tr>
                                <td class="field">Email:</td>
                                <td class="value">
                                    {{$contributeur->contact->email}}
                                </td>
                            </tr>
                            <tr>
                                <td class="field">Tel: </td>
                                <td class="value">
                                    {{$contributeur->contact->tel}}
                                </td>
                            </tr>
                            <tr>
                                <td class="field">Adresse: </td>
                                <td class="value">
                                    {{$contributeur->contact->adresse}}
                                </td>
                            </tr>
                            <tr>
                                <td class="field">Code Postale: </td>
                                <td class="value">
                                    {{$contributeur->contact->code_postal}}
                                </td>
                            </tr>
                            <tr>
                                <td class="field">Ville : </td>
                                <td class="value">
                                    {{$contributeur->contact->id_contact}}
                                </td>
                            </tr>
                            <tr>
                                <td class="field" style="width:50%">Numero CSE : </td>
                                <td class="value">
                                    {{$contributeur->contact->num_cse }}
                                </td>
                            </tr>
...
<!-- --------------------- Contributions ------------------- -->
                    ...
                    <table style="margin-top:30px;margin-left:0px;width:90%">
                        <tbody>
                            @foreach ($contributeur->contributions as $contribution)
...
<div class="col-md-4" style="max-width: 35%">
    <div class="tab-content p-0">
        <div class="tab-pane active show" id="profile-about" style="margin-left: 25px;">
            <table class="table table-profile">
                <thead>
                    <tr style="padding: 0;">
                        <th style="padding: 0 0 0 0;" colspan="2">Contribution</th>
                    </tr>
                </thead>
            </table>

            <table style="width: 200%; margin-left: 0;">
                <tbody>
                    <tr>
                        <td style="width: 80px"><b>Id Exp</b></td>
                        <td><b style="margin-right: 20px">Num Exp</b></td>
                        <td><b style="margin-right: 20px">Montant</b></td>
                        <td><b style="margin-right: 30px">Exp</b></td>
                        <td><b style="margin-right: 20px">Lien</b></td>
                        <td><b style="margin-right: 50px">Date</b></td>
                        <td><b style="">Stripe</b></td>
                    </tr>
                    
                    @foreach($contributeur->contributions as $contribution)
                    <tr>
                        <td>{{ $contribution->idExperience()}}</td>
                        <td>{{ $contribution->numExperience()}}</td>
                        <td>{{ $contribution->montant }}</td>
                        <td>{{ $contribution->nomExperience()}}</td>
                        <td> <b style=" color:red"><a href="">
                             GO</b>
                        </a>
...
<!-- --------------------- Evenements ------------------- -->
                    ...
                    <table class="table table-profile"style="margin-top:-120px; margin-left:750px">
                        <thead>
                            <tr style="padding:0;">
    ...
    <form method="post">
        @csrf
        @method('DELETE')
    <table class="table table-profile"style="margin-top:-125px; margin-left:300px">
        <thead>
            <tr style="padding:0;">
                            ...
                            @foreach ($commentaires as $commentaire)
                                <tr style="border-radius:10px;margin-bottom:10px">
                                    <td style="text-align: justify;padding:0.5rem">
                                        <b >{{ $commentaire->date_creation }} {{ $commentaire->experience->nom_experience }}</b>
