...
class CreateSuppGroupeavecambassadeursTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::connection('mysql')->create('supp__groupeavecambassadeurs', function (Blueprint $table) {
            $table->unsignedBigInteger('id');
            $table->string('id_groupe', 8000);
            $table->string('nom')->nullable();
            $table->string('personnalisation', 1000)->nullable();
            $table->string('nb_membres')->nullable();
            $table->string('theme', 3000)->nullable();
    ...
    {
        Schema::dropIfExists('supp__groupeavecambassadeurs');
    }
}
