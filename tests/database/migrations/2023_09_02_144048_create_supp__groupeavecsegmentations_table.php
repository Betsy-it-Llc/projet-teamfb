...
class CreateSuppGroupeavecsegmentationsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::connection('mysql')->create('supp__groupeavecsegmentations', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('supp__groupeavecsegmentations');
    }
}
