...
class CreateSuppGroupesanssegmentationsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::connection('mysql')->create('supp__groupesanssegmentations', function (Blueprint $table) {
            $table->integer('id');
    ...
    {
        Schema::dropIfExists('supp__groupesanssegmentations');
    }
}
