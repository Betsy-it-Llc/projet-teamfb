...
class CreateSuppGroupesansambassadeursTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::connection('mysql')->create('supp__groupesansambassadeurs', function (Blueprint $table) {
            $table->string('id_groupe', 300);
    ...
    {
        Schema::dropIfExists('supp__groupesansambassadeurs');
    }
}
