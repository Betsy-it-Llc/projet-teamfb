...
class GroupesansambassadeurController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $groupesansambassadeurs = Groupesansambassadeur::latest()->paginate($perPage);
        return view('groupesansambassadeurs.index',compact('groupesansambassadeurs','perPage'))
    ...
    public function multisearch_sans_amb(Request $request){
        ...
        return view('groupesansambassadeurs.index',['groupesansambassadeurs'=>$groupesansambassadeurs,'perPage',$perPage])
        ->with('i', (request()->input('page', 1) - 1) * 5);
