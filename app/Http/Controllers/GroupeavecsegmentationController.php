...
class GroupeavecsegmentationController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('groupeavecsegmentations.index', compact('groupeavecsegmentations','perPage'))
...
*/
    ...
    public function multisearch_g_a_segmentation(Request $request)
    {
        ...
        return view('groupeavecsegmentations.index', ['groupeavecsegmentations' => $groupeavecsegmentations,'perPage'=>$perPage])
            ->with('i', (request()->input('page', 1) - 1) * 5);
    }
